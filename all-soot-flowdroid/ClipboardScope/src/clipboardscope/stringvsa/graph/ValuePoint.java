package clipboardscope.stringvsa.graph;
...
import clipboardscope.stringvsa.backwardslicing.BackwardContext;
import clipboardscope.stringvsa.backwardslicing.BackwardController;
import clipboardscope.stringvsa.backwardslicing.DataSourceType;
import clipboardscope.stringvsa.base.StmtPoint;
import clipboardscope.stringvsa.base.TargetType;
import clipboardscope.stringvsa.forwardexec.SimulateEngine;
...
public class ValuePoint implements IDGNode {
		...
		for (String tins : instrs.keySet()) {
			...
			if (tins.contains(
				...
				if (tins.contains(">(taintedVariable")) {
					regIndex.add(1);	// Second arg
				} else {
					regIndex.add(0);	// First arg
				}
			} else {
				if (tins.contains("taintedVariable.<")) {
					regIndex.add(0);
	...
	public static String getSignature(String instruction) {
		...
		} else if (instruction.contains("<java.lang.String: boolean startsWith(java.lang.String)>")) {
			signature = "<java.lang.String: boolean startsWith(java.lang.String)>";
		} else if (instruction.contains("<java.lang.String: boolean endsWith(java.lang.String)>")) {
			signature = "<java.lang.String: boolean endsWith(java.lang.String)>";
		} else if (instruction.contains("<java.lang.String: boolean matches(java.lang.String)>")) {
			signature = "<java.lang.String: boolean matches(java.lang.String)>";
		} else if (instruction.contains("<java.util.regex.Pattern: boolean matches(java.lang.String,java.lang.CharSequence)>")) {
			signature = "<java.util.regex.Pattern: boolean matches(java.lang.String,java.lang.CharSequence)>";
		}
		return signature;
	}
